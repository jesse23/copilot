...
export default function SampleForm() {
  ...
  useEffect(() => {
    setCategory("command configuration");
    const subs = eventBus.subscribe("copilot.update", ({ response }) => {
      ...
      const res = {
        ...
        ...((Object.values(vm.commandHandlers||{})||[{}])[0] as Record<string, string>),
        ...((Object.values(vm.commandPlacements||{})||[{}])[0] as Record<string, string>),
      } as any;
        ...
        <Allotment.Pane>
          <div style={{ padding: "10px" }}>
            <FormControl>
              ...
              <Button onClick={() => setResult(command)}>Create Command</Button>
              </div>
            </FormControl>
          </div>
        </Allotment.Pane>
